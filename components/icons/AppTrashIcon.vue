<template>
  ...
  >
    <path
      ...
      class="dark:fill-[#2B2939] fill-[#D3D3D3] text-xl transition-all group-hover/native:fill-washed-purple-400"
    />
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      ...
      class="dark:fill-[#817EB5] fill-Neutrals/neutrals-7 transition-all group-hover/native:fill-washed-blue-500"
    />
    <path
      fillRule="evenodd"
      clipRule="evenodd"
